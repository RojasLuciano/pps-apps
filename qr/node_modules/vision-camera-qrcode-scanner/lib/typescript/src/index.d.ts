 ...
 */
export declare enum QrCodeAddressType {
    UNKNOWN = 0,
    WORK = 1,
    HOME = 2
}
 ...
 */
export declare enum QrCodeEmailType {
    UNKNOWN = 0,
    WORK = 1,
    HOME = 2
}
 ...
 */
export declare enum QrCodePhoneType {
    UNKNOWN = 0,
    WORK = 1,
    HOME = 2,
    FAX = 3,
 ...
 */
export declare enum QrCodeWifiType {
    OPEN = 1,
    WPA = 2,
    WEP = 3
}
 ...
 * Scans QR codes.
 */
export declare function scanQRCodes(frame: Frame): QrCode[];
